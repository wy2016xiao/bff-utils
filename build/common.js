 ...
 */
function formatServiceWarning(data) {
...
exports.formatServiceWarning = formatServiceWarning;
/**
 * 聚合各服务返回值在同一个对象内
 ...
 * @returns
 */
function formatControllerWarning(params) {
    let res = {
        code: 0,
        data: {},
        error: []
...
exports.formatControllerWarning = formatControllerWarning;
